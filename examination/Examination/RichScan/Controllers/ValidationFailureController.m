...
//    validationLabel.backgroundColor = [UIColor orangeColor];
    ...
    _timeLabel = [[UILabel alloc]initWithFrame:CGRectMake((kWidth-160)/2, CGRectGetMaxY(validationLabel.frame)+4, 160, 11)];
...
//    _timeLabel.backgroundColor = [UIColor yellowColor];
    ...
    retryBtn.backgroundColor = RGBCOLOR(253, 163, 70);;
