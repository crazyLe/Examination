...
@interface RichScanViewController ()<ZBarReaderViewDelegate,UITextFieldDelegate,UIActionSheetDelegate>
{
    CGFloat jianju;
    CGFloat scale;
}
...
//{
//    if (self = [super init]) {
//        [self rdv_tabBarController].tabBar.tintColor = [UIColor blackColor];
...
- (void)viewDidLoad {
    ...
    readerView.frame = CGRectMake(0, 0, kWidth , kHeight+49);
...
//    [keep addTarget:self action:@selector(click) forControlEvents:UIControlEventTouchUpInside];
    keep.backgroundColor = RGBCOLOR(253, 163, 70);
//    keep.backgroundColor = [UIColor colorWithHexString:@"#ffa4a3"];
//    keep.backgroundColor = [UIColor blackColor];
