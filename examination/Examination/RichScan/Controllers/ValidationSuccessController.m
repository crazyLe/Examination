...
//    _downImageView.backgroundColor = [UIColor redColor];
    ...
    _downImageView.image = [UIImage imageNamed:@"图层-2"];
...
//    customStr = [[NSMutableAttributedString alloc]initWithString:_model.trueName attributes:@{NSForegroundColorAttributeName:[UIColor colorWithHexString:@"#666666"],NSFontAttributeName:[UIFont systemFontOfSize:16]}];
    customStr = [[NSMutableAttributedString alloc]initWithString:@"333" attributes:@{NSForegroundColorAttributeName:[UIColor colorWithHexString:@"#666666"],NSFontAttributeName:[UIFont systemFontOfSize:16]}];
...
- (void)createDownView
{
    ...
    costImageView.image = [UIImage imageNamed:@"费用信息"];
